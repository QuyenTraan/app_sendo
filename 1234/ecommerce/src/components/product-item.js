...
// query myQuery($name: String, $uId: Int, $before: String, $after: String, $first: Int, $last: Int) {
//   items(name: $name, uId: $uId, before: $before, after: $after, first: $first, last: $last) {
//     pageInfo {
//       startCursor
//       endCursor
//       hasNextPage
